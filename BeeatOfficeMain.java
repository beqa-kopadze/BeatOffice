...
public class BeeatOfficeMain {
    ...
    public static void main (String[] args) {
        if (args.length > 0) {
            ...
            new BeeatOfficeMain().startUp(args[0]); // args[0] is your user ID/screen name
        } else {
            System.out.println("No arguments provided.");
        }
        String uniqueID = UUID.randomUUID().toString();
        new BeeatOfficeMain().startUp(uniqueID);
    }
        ...
        for (int i = 0; i < 16; i++) {
            ...
            for (int j = 0; j < 16; j++) {
                ...
                if (jc.isSelected()) {
                    ...
                    trackList.add(key);//it was new Integer(key);
                } else {
